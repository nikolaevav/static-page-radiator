   ...
   */
    ...
    */
    ...
    var cuselFrame = '<div class="cusel '+chElClass+' '+classDisCusel+'"'+
            ...
            ' tabindex="'+chElTab+'"'+
            '>'+
            '<div data-class="'+defaultSetClass+'" class="cuselText '+defaultSetClass+'">'+defaultAddTags + '<label>'+activeOpt.text()+'</label><div class="cuselFrameRight"></div></div>'+
...
function cuselChange(select,setItem) {
    ...
    if (typeof setItemVal == "undefined")
        ...
        select
                .find(".cuselText").removeClass(prevClass).data('class',addClass).addClass(addClass).html( setItem.html() + '<div class="cuselFrameRight"></div>').end()
